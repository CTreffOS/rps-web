<?php
  if(isset($_SESSION['code'])&& isset($_SESSION['voucher']))
  {
    ...
    $query->bindParam(':code', $code, PDO::PARAM_INT);
	 if($query->execute()) 
	 {
		 echo('Registration was successful. <br/>Choose your upload type:<ul><li><a href="index.php?site=docker">Provice Docker image on docker.io</a></li><li><a href="index.php?site=upload">Upload tar archive with code files</a></li></ul>') ;
		 $db = NULL;
	 }
	 else 
	 {
